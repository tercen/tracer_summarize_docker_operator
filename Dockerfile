...
RUN tar xzvf cmake-3.20.1-linux-x86_64.tar.gz
...
RUN tar xzvf trinityrnaseq-v2.12.0.FULL.tar.gz
...
RUN tar xzvf ncbi-igblast-1.17.1-x64-linux.tar.gz
...
RUN tar xzvf jellyfish-2.3.0.tar.gz
...
RUN echo 0.0.1.4 && git pull
RUN echo 0.0.1.4 && git checkout
